    ...
    if (user) {
      firebase.database().ref('bd').
        on('child_added', function(s) {
          ...
          $('#container-gamers').prepend('<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 container-all-gamers container-icon">' + '<div data-code="' + allGamersCode + '" id="code-gamers"  class="col-xs-12 col-sm-12 col-md-2 col-lg-1">' + 
