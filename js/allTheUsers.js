    ...
    if (user) {    
      firebase.database().ref('bd').
        on('child_added', function(s) {
          ...
          '<img class="profile img-responsive img-circle center-block" src=\'' + user.photo + '\' />' + '</div>' + '<div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-6 col-lg-9 col-lg-offset-0">' + 
